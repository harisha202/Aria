...
<div style="background:#071426; border:1px solid #213a5c; border-radius:8px; padding:16px; margin:18px 0 22px;">
    ...
    <div style="font-size:14px; color:#c7d5e8; margin-bottom:10px;"><strong>Type:</strong> {safe_type}</div>
    {rating_line}
</div>
<div style="background:#071426; border:1px solid #213a5c; border-radius:8px; padding:18px; margin-top:22px;">
    <div style="font-size:12px; color:#9fb3cc; text-transform:uppercase; letter-spacing:1px; font-weight:700; margin-bottom:10px;">Message</div>
...
<div style="background:#0b2238; border-left:4px solid #38b6ff; padding:14px 16px; border-radius:6px; font-size:14px; line-height:1.8; color:#bfdbfe; margin-bottom:22px;">
    <div><strong>Feedback type:</strong> {safe_type}</div>
    <div><strong>Rating:</strong> {rating_text}</div>
</div>
<div style="background:#071426; border:1px solid #213a5c; border-radius:8px; padding:18px;">
    <div style="font-size:12px; color:#9fb3cc; text-transform:uppercase; letter-spacing:1px; font-weight:700; margin-bottom:10px;">Your message</div>
